...
// Завдання 2: Дано масив, використовуючи цикл "for of" знайдіть суму всіх елементів масиву
...
function printStrings(array) {
  return array.toString().repeat(2).trim();
...
function concatenateStrings(array, subString) {
  return array.toString().includes(subString);
...
function getEvenNumbers(arr) {
  ...
  for (let n of arr) {
    if (n % 2 === 0) {
      EvenNumbers[EvenNumbers.length] = n;
    }
  }
  return EvenNumbers;
...
function replaceNumbers(arr) {
  ...
  for (let n of arr) {
    if (n > 10) {
      replace[replace.length] = "Greater than 10";
    } else {
      replace[replace.length] = "Less than or equal to 10";
    }
  }
